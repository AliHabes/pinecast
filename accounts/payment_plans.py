...
FEATURE_MIN_CNAME = PLAN_STARTER
FEATURE_MIN_BLOG = PLAN_PRO
FEATURE_MIN_SITE_FAVICON = PLAN_PRO
FEATURE_MIN_NOTIFICATIONS = PLAN_PRO
FEATURE_MIN_COLLABORATORS = PLAN_PRO
FEATURE_MIN_PRIVATE_EPS = PLAN_STARTER
FEATURE_MIN_PRIVATE_EPS_OPTIONS = PLAN_PRO
...
PLANS_RAW = {
    ...
    'FEATURE_MIN_SITE_FAVICON': FEATURE_MIN_SITE_FAVICON,
    'FEATURE_MIN_CNAME': FEATURE_MIN_CNAME,
    'FEATURE_MIN_NOTIFICATIONS': FEATURE_MIN_NOTIFICATIONS,
    'FEATURE_MIN_COLLABORATORS': FEATURE_MIN_COLLABORATORS,
    'FEATURE_MIN_PRIVATE_EPS': FEATURE_MIN_PRIVATE_EPS,
    'FEATURE_MIN_PRIVATE_EPS_OPTIONS': FEATURE_MIN_PRIVATE_EPS_OPTIONS,
}
